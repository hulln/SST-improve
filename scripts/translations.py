"""
Translation tables and helpers for GOS-derived metadata.

These map the Slovenian metadata values found in the GOS 2.1 TSVs to the English
labels emitted into the enriched CoNLL-U files. Moved verbatim from the original
single-file SST script so both SST and GOS enrichment share one source of truth.
"""
